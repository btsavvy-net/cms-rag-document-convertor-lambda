...
def upload_ir_jsonl(elements: list, tenant_id: str, doc_id: str, schema_version: str = "ir_v1") -> str:
    """
    ...
    elements_sorted = sorted(
        elements,
        key=lambda e: (e["page"], e["bbox"]["y0"], e["bbox"]["x0"])
    )
...
def update_source_object_tags(bucket_name: str, object_key: str, has_tables: bool = False):
    """
